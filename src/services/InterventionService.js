...
export default {
  ...
  removeQuittances(interventionId, quittancesId) {
    return Api.api().delete("/interventions/" + interventionId + "/quittances", {
  ...
  addSapeurs(interventionId, sapeursData) {
    return Api.api().post("/interventions/" + interventionId + "/sapeurs", sapeursData);
  },
  editSapeurs(interventionId, sapeursData) {
    return Api.api().put("/interventions/" + interventionId + "/sapeurs", sapeursData);
  },
  ...
  downloadRapport(interventionId, params, filename) {
    return Api.apiFileDownload(filename).get("/interventions/" + interventionId + "/rapport", {
      params,
    });
  },
};
