...
const recurrenceLabel = (controle) => {
  ...
  if (controle.nb_execution_max) {
    const preavis = controle.nb_execution_preavis
      ? ` (préavis dès ${controle.nb_execution_preavis})`
      : "";
    return `Max ${controle.nb_execution_max} exécutions${preavis}`;
  }
  return "";
};
      ...
      >
        ...
        <template #detail-row="{ rowData }">
          <div class="p-3 bg-light border-top">
            <strong class="d-block mb-2">Tâches — {{ rowData.nom }}</strong>
