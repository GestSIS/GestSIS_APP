...
const confirmer = () => {
  ...
  SapeurService.listeFoad(date.value)
    .catch((error) => {
      awn.warning(error?.message ?? "Erreur lors de la génération de la liste Foad");
    })
    .then(closeModal);
};
</script>
...
<template>
  <div>
    ...
    <div class="modal-footer">
      <button autofocus type="button" class="btn btn-secondary" @click="closeModal">Annuler</button>
