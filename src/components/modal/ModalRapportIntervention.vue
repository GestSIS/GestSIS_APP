<template>
  <div>
    <div class="modal-header">
      <h5 class="modal-title" id="exampleModalLabel">Rapport d'intervention - Configuration</h5>
    ...
    <div class="modal-body">
      ...
      <div class="form-check">
        <input type="checkbox" class="form-check-input" id="groupes" v-model="params.groupes" />
      ...
      <div class="form-check">
        <input type="checkbox" class="form-check-input" id="materiel" v-model="params.materiel" />
        <label class="form-check-label" for="materiel">Matériel utilisé</label>
      </div>
      <div class="form-check">
        <input type="checkbox" class="form-check-input" id="absents" v-model="params.absents" />
        <label class="form-check-label" for="absents">Sapeurs non-présent</label>
      </div>
      <div class="form-check">
        <input type="checkbox" class="form-check-input" id="statut" v-model="params.statut" />
        <label class="form-check-label" for="statut">Indication du traitement du rapport</label>
      </div>
      <div class="form-check">
        <input type="checkbox" class="form-check-input" id="missions" v-model="params.missions" />
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-primary" @click="generer()">Générer</button>
    </div>
  </div>
</template>
