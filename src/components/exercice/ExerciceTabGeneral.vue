<template>
  <div class="card card-primary card-outline">
    <div class="card-header d-flex justify-content-between">
      <span></span>
      <button class="btn btn-outline-primary" @click="save" v-if="hasEditPermission">
    ...
    <div class="card-body">
      ...
      <div class="mb-3">
        ...
        <input type="text" :readonly="!hasEditPermission" class="form-control form-control-sm"
          :class="{ 'is-invalid': errors['designation'] }" id="m-exe-des" name="nom"
          v-model="activeExerciceData.designation" />
      </div>
      <!-- CATEGORIE -->
      <div class="mb-3">
        <label for="m-sap-cat">Categorie</label>
        <select :disabled="!hasEditPermission" class="form-select form-select-sm" required
          ...
          <option v-for="categorie in listeCategories" :key="categorie.id" :value="categorie.id">
        ...
        <div class="col-6">
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-sm">
              ...
              <input type="date" :readonly="!hasEditPermission" class="form-control form-control-sm"
                :class="{ 'is-invalid': errors['date'] }" id="m-exe-date" name="nom"
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-sm">
              ...
              <input type="time" :readonly="!hasEditPermission" class="form-control form-control-sm"
                :class="{ 'is-invalid': errors['heure'] }" id="m-exe-heure" name="nom"
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-sm">
              ...
              <input type="number" :readonly="!hasEditPermission" class="form-control form-control-sm"
                :class="{ 'is-invalid': errors['duree'] }" min="1" max="780" id="m-exe-duree" name="nom"
      ...
      <div class="row">
        <div class="col-6">
          ...
          <div class="mb-3">
            ...
            <select :disabled="!hasEditPermission" class="form-select form-select-sm" required
              :class="{ 'is-invalid': errors['localite_id'] }" id="m-sap-localite" name="localite_id"
              style="width: 100%" v-model="activeExerciceData.localite_id">
        ...
        <div class="col-6">
          ...
          <div class="mb-3">
            ...
            <input type="text" :readonly="!hasEditPermission" class="form-control form-control-sm"
              :class="{ 'is-invalid': errors['lieu'] }" id="m-exe-lieu" name="nom" v-model="activeExerciceData.lieu" />
          </div>
        </div>
      </div>
      <!-- COMMUNICATION -->
      <div class="mb-3">
        ...
        <textarea type="text" :readonly="!hasEditPermission" class="form-control form-control-sm"
          ...
          v-model="activeExerciceData.communications"></textarea>
      </div>
    </div>
  </div>
</template>
