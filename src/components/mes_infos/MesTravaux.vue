...
await Promise.all([travailTypeStore.fetchTravailTypes(), uniteStore.fetchUnites()]);
...
<template>
  <div class="card card-primary card-outline mb-3">
    <div class="card-header d-flex justify-content-between">
      ...
      <button v-if="hasSaisiePermission" type="button" class="btn btn-primary" @click="addTravail">
