          ...
          <table class="table table-sm table-bordered">
            <thead>
              <tr>
                ...
                <th v-for="(col, i) in columns" :key="i" colspan="4" class="text-center ps-3 pe-3">
                  {{ col }}h
                </th>
              </tr>
              <tr>
            ...
            <tbody v-if="sortedSapeurs.length <= 0">
              <tr>
                <td :colspan="2 + columns.length * 4">Aucun sapeur présent pour l'instant</td>
              </tr>
            </tbody>
              ...
              <tr>
                <th class="ms-0 ps-1">
                  <button
                    ...
                    :title="toggles[s.id] ? 'Masquer le détail' : 'Afficher le détail'"
                ...
                <td class="text-center">
                  <input
                    ...
                    aria-label="Quittance"
                    :checked="quittances.filter((q) => q.sapeur_id === parseInt(s.id)).length === 1"
