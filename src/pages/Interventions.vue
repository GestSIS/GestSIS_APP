        ...
        <div class="card card-primary card-outline mb-2">
          ...
          <div class="card-body d-grid gap-1">
            <router-link custom to="/interventions/new" v-slot="{ navigate }">
              <button @click="navigate" class="btn btn-outline-primary" v-if="hasEditPermission">Ajouter une
                intervention</button>
            </router-link>
            <router-link custom :to="'/interventions/' + selectedId" v-slot="{ navigate }">
              <button :disabled="!selectedId" @click="navigate" class="btn btn-outline-primary">{{ hasEditPermission ?
                  "Modifier" : "Aperçu"
              }}</button>
            </router-link>
            <button :disabled="!canDelete" @click="supprimerIntervention(selectedId)" class="btn btn-outline-primary"
              v-if="hasEditPermission">Supprimer</button>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        ...
        <div class="card card-primary card-outline mb-2">
          ...
          <div class="card-body d-grid gap-1">
            <button :disabled="!selectedId" @click="rapportIntervention" class="btn btn-outline-primary">Rapport
              d'intervention</button>
          </div>
        </div>
      </div>
      <div class="col-md-6">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                ">
                  <option>&lt;Type&gt;</option>
                  <option v-for="type in filteredInterventionsTypes" :key="type.id" :value="type.id">{{ type.designation
                  }}</option>
                </select>
              </div>
              <div class="col-md-4">
                ...
                ">
                  ...
                  <option v-for="stat in filteredStatFederal" :key="stat.id" :value="stat.id">{{ stat.designation }}
                  </option>
                </select>
              </div>
              <div class="col-md-4">
